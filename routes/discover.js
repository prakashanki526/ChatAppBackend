...
const {register, login, getUser, updateUser, generateOTP, verifyOTP, createResetSession, resetPassword, verifyUser, checkUserExist} = require('../controllers/appController.js');
